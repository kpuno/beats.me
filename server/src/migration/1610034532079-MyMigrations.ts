...
export class MyMigrations1610034532079 implements MigrationInterface {
    name = 'MyMigrations1610034532079'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "post" ADD "creator" character varying NOT NULL`);
